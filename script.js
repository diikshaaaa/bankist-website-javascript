...
const account1 = {
  owner: "Diksha Grover",
  movements: [100, 355.23, -706.5, 55000, -742.21, -233.9, 59.97, 1700],
  interestRate: 1.2, // %
  pin: 1111,
...
const formatMovementDate = function (date, locale) {
  ...
  // we will get days in milliseconds, so to convert that to hrs we have divided it to (1000 * 60 * 60 * 24)
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    // insertAdjacentHTML() is a method of the Element interface so that you can invoke it from any element. The insertAdjacentHTML() method parses a piece of HTML text and inserts the resulting nodes into the DOM tree at a specified position: element.insertAdjacentHTML(positionName, text);
...
// event listener when user log in to his account
...
// event listener when user transfers money
...
// event listener when user seeks loan
